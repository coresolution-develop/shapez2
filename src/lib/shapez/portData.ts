...
export const CONFIRMED_PORTS: Record<string, ConfirmedPorts> = {
  ...
  CrystalGeneratorDefaultInternalVariant: {
    ...
    samples: 36,
    source: 'fixture',
    fixture: 'crystal generator module, 1x2 platform',
    note: 'The paint goes in beside the far tile — the machine is 1x2, and the pipe meets the -X face of the tile the belts do not touch. Thirty-six of them in a player module agree without exception, which settles a reading that was withdrawn once before for being taken from pipes wrongly treated as directional.',
  },
  CrystalGeneratorDefaultInternalVariantMirrored: {
    ...
    source: 'fixture',
    fixture: 'crystal generator module, 1x2 platform',
    note: 'The mirror of the above, and mirrored in exactly the way that predicts.',
  },
  FluidPortReceiverInternalVariant: {
    ...
    source: 'fixture',
    fixture: 'crystal generator module, 1x2 platform',
    note: 'Where paint arrives on a platform. It carries no belts at all — the pipe leaves its +X face.',
  },
