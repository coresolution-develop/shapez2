 ...
 *
 * Scenario and milestone names are not in here: they ship inside the scenario
 * data, so `progression.json` carries them alongside the thing they name (see
 * `scripts/extractScenarios.py`).
 */
